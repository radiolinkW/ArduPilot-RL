...
//    uint32_t get_reversed_mask() override { return 1; }
    /*
...
private:
    ...
    float Dshot_scaling = 1.05;
    float Dshot600_scaling = 1.15;
    float Dshot1200_scaling = 0.83;
    // dshot period
    ...
    */
    ...
    static void bdshot_config_icu_dshot(pwm_group* group, uint8_t chan, uint8_t ccr_ch);
    ...
    void fill_DMA_buffer_byte(uint32_t *buffer, uint8_t stride, uint8_t b, uint16_t pconrx, uint32_t bitval);
