...
public:
    ...
    bool is_rx_active() const override {
        ...
        return _last_rx_frame_time_us != 0 && AP_HAL::Calclate_dt(AP_HAL::micros(),_last_rx_frame_time_us) < CRSF_RX_TIMEOUT;
    }
    ...
    bool is_tx_active() const {
        ...
        return _last_tx_frame_time_us != 0 && AP_HAL::Calclate_dt(AP_HAL::micros(),_last_tx_frame_time_us) < CRSF_TX_TIMEOUT;
    }
