...
#define SPL06_TEMP_RATE_8HZ				       (0x03 << 4)
...
#define READ_LENGTH 9
	...
	_dev->write_register(SPL06_REG_TEMPERATURE_CFG, tmp_sensor | SPL06_TEMP_RATE_8HZ | SPL06_OVERSAMPLING_TO_REG_VALUE(SPL06_TEMPERATURE_OVERSAMPLING), true);
